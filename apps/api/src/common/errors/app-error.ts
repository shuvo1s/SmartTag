...
export const ERROR_HTTP_STATUS: Readonly<Record<ErrorCode, number>> = {
  ...
  UNSUPPORTED_IMPORT_FORMAT: 415,
  IMPORT_FILE_TOO_LARGE: 413,
  IMPORT_FILE_MALFORMED: 422,
  WORKBOOK_LIMIT_EXCEEDED: 422,
  INVALID_SOURCE_SETTINGS: 422,
  MAPPING_INCOMPLETE: 422,
  TARGET_FIELD_ALREADY_MAPPED: 422,
  IMPORT_NOT_READY: 409,
  TEMPLATE_VERSION_CHANGED: 409,
  DATASET_HAS_ERRORS: 409,
  WARNINGS_NOT_ACKNOWLEDGED: 409,
  DATASET_IMMUTABLE: 409,
  MAPPING_PROFILE_INCOMPATIBLE: 409,
  // Production jobs (Phase 5)
  TEMPLATE_NOT_APPROVED: 409,
  DATASET_NOT_FINALIZED: 409,
  TEMPLATE_DATASET_SCHEMA_MISMATCH: 422,
  CUSTOMER_MISMATCH: 422,
  INVALID_QUANTITY_FIELD: 422,
  INVALID_PRODUCTION_CONFIGURATION: 422,
  INSTANCE_LIMIT_EXCEEDED: 422,
  SEQUENCE_INACTIVE: 409,
  SEQUENCE_EXHAUSTED: 409,
  SEQUENCE_RESERVATION_FAILED: 409,
  PRODUCTION_JOB_NOT_READY: 409,
  PRODUCTION_JOB_HAS_ERRORS: 409,
  PRODUCTION_WARNINGS_NOT_ACKNOWLEDGED: 409,
  PRODUCTION_JOB_IMMUTABLE: 409,
  PRODUCTION_MANIFEST_NOT_READY: 409,
};
